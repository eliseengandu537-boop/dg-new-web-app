...
const content_data: ContentType = {
   ...
   desc_2: "Your leading real estate advocate, transforming houses into dreams. Trust us to expertly guide you home.  745,000 apartments & home for sell, lease & mortgage.",
   project_details: [
      {
         count: "01",
