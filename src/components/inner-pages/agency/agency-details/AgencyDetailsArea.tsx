...
const agency_details_content: ContentType = {
   ...
   desc_1: contactInfo.locationName,
   desc_4: "Sales & Broker",
   table_data: [{ table_td_1: "Location", table_td_2: contactInfo.fullAddress }, { table_td_1: "Phone:", table_td_2: contactInfo.phoneDisplay }, { table_td_1: "Email", table_td_2: contactInfo.emailDisplay }, { table_td_1: "Website:", table_td_2: "dg-property.co.za" },],
