...
interface ContentType {
   ...
   service_list: string[];
   sidebar_list: { title: string; href: string }[];
}[];
...
const content_data: ContentType = {
   ...
   desc_4: (<>Our work extends beyond traditional brokerage. We draw on an established industry network and provide supporting services including tailored email campaigns, websites, brochures, and social media strategies for relevant property opportunities.</>),
   service_features: [
      {
   ...
   sidebar_list: [
      { title: "Commercial Leasing", href: "/commercial-for-lease" },
      { title: "Investment Sales", href: "/investment-sales" },
      { title: "Tenant Representation", href: "/inquiry" },
      { title: "Development Land", href: "/development-land" },
   ],
}
               ...
               <div className="col-lg-8">
                  <div className="service-post">
                     ...
                     <div className="img-gallery pt-15 pb-70 lg-pb-50">
                        <div className="row">
                           <div className="col-8">
                              <Image src={seviceDetailsThumb_1} alt="Modern retail storefronts available through DG Property" className="lazy-img w-100 mt-20" />
                           </div>
                           <div className="col-4">
                              <Image src={seviceDetailsThumb_2} alt="Contemporary shopping centre interior" className="lazy-img w-100 mt-20" />
                           </div>
                        </div>
                     </div>
                              ...
                              {service_features.map((item, index) => (
                                 <div key={index} className="col-xl-4 col-lg-6 col-md-4">
                                    <div className="card-style-eleven mt-30">
                                       <div className="icon"><Image src={item.icon} alt="" aria-hidden="true" className="lazy-img" /></div>
                     ...
                     <div style={{ marginTop: 20 }}>
                        <Link href="/retail-properties" style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "linear-gradient(90deg, #c8973a, #e8b86d)", color: "#fff", fontWeight: 600, fontSize: 15, padding: "14px 34px", borderRadius: 50, textDecoration: "none", letterSpacing: 0.4 }}>
                     ...
                     <div className="service-sidebar md-mt-80">
                        <div className="service-category">
                           <ul className="style-none">
                              <li><Link href="/retail-leasing" className="active" aria-current="page">Retail Leasing</Link></li>
                              {sidebar_list.map((item) => <li key={item.href}><Link href={item.href}>{item.title}</Link></li>)}
                           </ul>
                        </div>
