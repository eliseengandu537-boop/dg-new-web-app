...
const ServiceThree = () => {
  return (
    <>
      ...
      {/* ── HERO BANNER ─────────────────────────────────────────────── */}
      <section style={{ position: "relative", minHeight: 520, display: "flex", alignItems: "center", backgroundImage: "url(/assets/images/media/op.jpeg)", backgroundSize: "cover", backgroundPosition: "center", overflow: "hidden" }}>
        {/* gold top line */}
