            ...
            <div className="container" style={{ position: "relative", zIndex: 2, paddingTop: 150, paddingBottom: 90 }}>
               <div className="row align-items-center">
                  <div className="col-lg-7">
                     ...
                     <nav aria-label="Breadcrumb">
                        <ol style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", gap: 8, flexWrap: "wrap" }}>
                           ...
                           <li aria-hidden="true" style={{ color: "rgba(255,255,255,0.45)", fontSize: 14 }}>/</li>
                           <li aria-current="page" style={{ color: "#fff", fontSize: 14 }}>Investment Sales</li>
                        </ol>
                     </nav>
                  </div>
                  <div className="col-lg-5 mt-4 mt-lg-0 text-lg-end">
                     ...
                     <Link href="/inquiry" style={{ display: "inline-block", background: "linear-gradient(90deg, #c8973a, #e8b86d)", color: "#fff", fontWeight: 600, fontSize: 15, padding: "14px 34px", borderRadius: 50, textDecoration: "none", letterSpacing: 0.5 }}>Discuss Your Investment</Link>
                  </div>
               </div>
            </div>
