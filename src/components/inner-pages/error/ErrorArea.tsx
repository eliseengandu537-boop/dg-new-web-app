...
const ErrorArea = () => {
   return (
      <div className="error-section position-relative z-1 bg-pink">
            ...
            <div className="row">
               <div className="col-xxl-8 col-xl-6 col-lg-7 col-md-8 m-auto">
                  <div className="title-one text-center mb-75 lg-mb-20 wow fadeInUp">
                     <h1><span>Oops! <Image src={titleShape} alt="" aria-hidden="true" className="lazy-img" /></span>It looks like you&apos;re lost.</h1>
         ...
         <Image src={errorImg} alt="" aria-hidden="true" className="lazy-img w-100 position-absolute bottom-0 start-0 z-n1" />
      </div>
   )
}
