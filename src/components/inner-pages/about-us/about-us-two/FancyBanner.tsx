...
import fanchyBannerShape_2 from "@/assets/images/media/nikk.png"
      ...
      <div className="fancy-banner-eight wow fadeInUp mt-160 xl-mt-100 mb-120 xl-mb-100 lg-mb-80">
         <div className="container container-large">
            <div
               ...
               style={{ padding: "10px clamp(20px, 5vw, 76px) 0" }}
            >
               <div className="row align-items-end">
                  <div className="col-xl-6 col-lg-7 col-md-7">
                     <div style={{ paddingBottom: "clamp(24px, 4vw, 58px)" }}>
                        <h3 style={{ fontSize: "clamp(2rem, 4.2vw, 3.8rem)", lineHeight: 1.05 }}>
                           Start your Journey as <span className="fw-normal fst-italic">A Retailer broker.</span>
                        </h3>
