    ...
    <>
      ...
      <section
        style={{
          ...
          display: "flex",
          alignItems: "flex-end",
          backgroundImage: "url(/assets/images/media/img_46.jpg)",
          ...
          <div className="row gy-5">
            ...
            <div className="col-lg-8 pe-lg-5">
              ...
              <p style={{ fontSize: 15.5, lineHeight: 1.9, color: "#4a5568", marginBottom: 20 }}>
                Steeledale Mall is a testament to what a strategic refurbishment can achieve. Located in Johannesburg South, the newly refurbished shopping centre has become the talk of the area, anchored by a Pick n Pay Hyper spanning 8 000m², it delivers a complete convenience retail experience to the surrounding community.
              </p>
              <p style={{ fontSize: 15.5, lineHeight: 1.9, color: "#4a5568", marginBottom: 20 }}>
                DG Property led the leasing strategy for this transformation, identifying the right anchor and specialty retail mix to revitalise the centre and reposition it in the local market.
              </p>
              <p style={{ fontSize: 15.5, lineHeight: 1.9, color: "#4a5568", marginBottom: 40 }}>
                The centre now draws consistent foot traffic from the broader Steeledale and surrounding areas, offering residents a modern, well-curated retail destination with a strong value proposition.
              </p>
              ...
              <div style={{ borderRadius: 12, overflow: "hidden", marginBottom: 40, boxShadow: "0 4px 18px rgba(0,0,0,0.10)" }}>
                <iframe
                  src="https://www.google.com/maps?q=Steeledale+Mall+Johannesburg+South+Africa&output=embed"
                  width="100%"
                  height="280"
            ...
            <div className="col-lg-4">
              <div style={{ background: "#f8f9fa", borderRadius: 16, padding: 32, position: "sticky", top: 100 }}>
                ...
                {[
                  { icon: "bi-calendar3", label: "Opening / Refurbished", value: "2023" },
                  { icon: "bi-geo-alt", label: "Location", value: "Steeledale, Johannesburg South" },
                  { icon: "bi-rulers", label: "GLA", value: "8 000 m²" },
                  { icon: "bi-shop", label: "Anchor Tenant", value: "Pick n Pay Hyper" },
                  { icon: "bi-arrow-up-circle", label: "Project Type", value: "Mall Refurbishment" },
                ].map((item, i) => (
...
export default SteeledaleMallDetail;
