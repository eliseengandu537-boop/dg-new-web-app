...
const courseHeroHighlights = [
  {
    ...
    desc: "Learn from DG Property CEO Michela De Gennaro.",
  },
  {
    icon: "bi-book",
    title: "Relevant Curriculum",
    desc: "A structured introduction to commercial property brokerage.",
  },
  {
    icon: "bi-tools",
      ...
      <main style={{ background: "#f7f8fb" }}>
          ...
          <div className="container" style={{ marginTop: -48, position: "relative", zIndex: 2 }}>
            ...
            <div className="row align-items-center g-5">
              <div className="col-lg-7">
                <p
                  className="text-uppercase fw-600 mb-15"
                  style={{ color: "#a34818", fontSize: "0.78rem", letterSpacing: "0.18em" }}
                >
                ...
                >
                  By CEO,
                  <br />
                  <span style={{ color: "#a34818" }}>Michela De Gennaro</span>
                </h2>
                <p style={{ fontSize: "1.02rem", color: "#55606d", lineHeight: 1.85, maxWidth: 560, marginBottom: 30 }}>
                  Commercial property education designed to introduce aspiring brokers
                  to the knowledge and practical concepts used in the industry.
                </p>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 14, alignItems: "center" }}>
                  ...
                  >
                    <i className="bi bi-play-circle" aria-hidden="true" style={{ color: "#a34818", fontSize: 18 }} />
                    Beginner friendly
                  </div>
                </div>
              </div>
              ...
              {courseHeroHighlights.map((f, i) => (
                <div className="col-md-4" key={i}>
                  ...
                  >
                    ...
                    >
                      <i className={`bi ${f.icon}`} aria-hidden="true" style={{ fontSize: 24, color: "#a34818" }} />
                    </div>
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-5">
              <div style={{ position: "relative" }}>
                ...
                >
                  <p style={{ fontSize: "0.75rem", color: "#595959", margin: 0 }}>CEO &amp; Lead Instructor</p>
                  <p style={{ fontSize: "1rem", fontWeight: 700, color: "#0f1f2e", margin: 0 }}>Michela De Gennaro</p>
                </div>
              </div>
            </div>
            <div className="col-lg-7">
              <p className="text-uppercase fw-600 mb-12" style={{ color: "#a34818", fontSize: "0.78rem", letterSpacing: "0.18em" }}>
              ...
              <div style={{ fontSize: "1rem", color: "#555", lineHeight: 1.85 }}>
                <p>
                  Michela works in the commercial property industry and leads DG Property.
                </p>
                <p>
                  Her work includes engaging with property funds, private investors, landlords and tenants.
                </p>
                <p>
                  The course draws on her experience with market research, negotiations, transactions and
                  professional networking.
                </p>
                <p>
                  It presents that experience as practical lessons for people entering the industry.
                </p>
              </div>
              <div className="row g-3 mt-20">
                {[
                  { num: "Online", label: "Course format" },
                  { num: "Self-paced", label: "Learning approach" },
                  ...
                  <div className="col-4" key={i}>
                    ...
                    >
                      <p style={{ fontSize: "1.8rem", fontWeight: 800, color: "#a34818", margin: 0 }}>{s.num}</p>
                      <p style={{ fontSize: "0.8rem", color: "#595959", margin: 0 }}>{s.label}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="container position-relative text-center" style={{ zIndex: 1 }}>
          <p
            ...
            style={{ color: "#f2bf72", fontSize: "0.78rem", letterSpacing: "0.2em" }}
          >
          ...
          >
            Build a practical foundation for a career in
            <br />
            <em style={{ color: "#f2bf72" }}>commercial property.</em>
          </h2>
        </div>
        </section>
                    ...
                    <div style={{ padding: "36px 32px" }}>
                      ...
                      <div style={{ display: "flex", gap: 20, flexWrap: "wrap", marginBottom: 20 }}>
                        <span style={{ display: "flex", alignItems: "center", gap: 6, color: "#555", fontSize: "0.88rem" }}>
                          <i className="bi bi-collection-play" aria-hidden="true" style={{ color: "#a34818" }} />
                          1 Module
                        </span>
                        <span style={{ display: "flex", alignItems: "center", gap: 6, color: "#555", fontSize: "0.88rem" }}>
                          <i className="bi bi-clock" aria-hidden="true" style={{ color: "#a34818" }} />
                          30 hours
                        </span>
                        <span style={{ display: "flex", alignItems: "center", gap: 6, color: "#555", fontSize: "0.88rem" }}>
                          <i className="bi bi-person-circle" aria-hidden="true" style={{ color: "#a34818" }} />
        ...
        <div className="container">
          ...
          <p className="mb-35" style={{ color: "rgba(255,255,255,0.7)", fontSize: "1rem" }}>
            Explore the course outline and contact DG Property if you need more information.
          </p>
