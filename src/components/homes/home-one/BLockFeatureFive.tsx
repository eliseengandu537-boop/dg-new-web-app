            ...
            <div className="row">
               <div className="col-xl-8 m-auto">
                  <div className="title-one text-center mb-35 lg-mb-20">
                     <h3>How we support <br /> <span>commercial property<Image src={titleShape} alt="" className="lazy-img" /></span> decisions.</h3>
                     <p className="fs-24 color-dark">A focused process for leasing, selling and positioning assets.</p>
                  </div>
               </div>
            </div>
