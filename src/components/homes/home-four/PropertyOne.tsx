         ...
         <div className="container container-large">
            <div className="position-relative">
               <div className="title-one mb-25 lg-mb-10 wow fadeInUp">
                  ...
                  <p className="fs-22">Explore latest and featured properties for sale, lease &amp; mortgage.</p>
               </div>
                        ...
                        <div className="listing-card-one style-two shadow-none h-100 w-100">
                                    ...
                                    <div className="carousel-inner">
                                       {item.carousel_thumb.map((item, i) => (
                                          <div key={i} className={`carousel-item ${item.active}`} data-bs-interval="1000000">
                                             <Link href={`/listing_details_01?id=${item.id}`} className="d-block"><Image src={item.img} className="w-100" alt="..." /></Link>
                                          </div>
                                       ))}
                                    </div>
                                 </div>
                           ...
                           <div className="property-info pt-20">
                              ...
                              <ul className="style-none feature d-flex flex-wrap align-items-center justify-content-between pb-15 pt-5">
                                 {item.property_info.map((info, index) => (
                                    <li key={index} className="d-flex align-items-center">
                                       {info.feature === "sqm" || info.feature === "sqft" ? (
                                          <i className="bi bi-rulers me-2" style={{ fontSize: 16 }} />
                                       ) : info.feature === "units" ? (
                                          <i className="bi bi-building me-2" style={{ fontSize: 16 }} />
                                       ) : (
                              ...
                              <div className="pl-footer top-border bottom-border d-flex align-items-center justify-content-between">
                                 ...
                                 <Link href={`/listing_details_01?id=${item.id}`} className="btn-four"><i className="bi bi-arrow-up-right"></i></Link>
                              </div>
                           </div>
                        </div>
                     </div>
