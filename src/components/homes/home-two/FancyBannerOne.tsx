               ...
               <div className="row">
                  <div className="col-xl-8 col-lg-9 ms-auto wow fadeInRight">
                     <div className="ps-xxl-5">
                        <div className="title-one mb-50 lg-mb-30 text-center">
                           <h2 className="font-garamond fs-xl home-two-one-line-title text-center">Why clients work with<br />DG Property.</h2>
                        </div>
                        <div className="row">
                           ...
                           <div className="col-lg-8">
                              <p className="fs-24 color-dark">Commercial sales, leasing and investment support delivered with discretion, responsiveness and strong relationships.</p>
