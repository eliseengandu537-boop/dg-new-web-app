...
const BreadcrumbOne = ({ title, sub_title, style, link, link_title, bgImage }: any) => {
      ...
      return (
         ...
         >
            ...
            <div className="container w-100" style={{ position: "relative", zIndex: 1 }}>
               ...
               <nav aria-label="Breadcrumb"><ol className="theme-breadcrumb style-none d-inline-flex align-items-center justify-content-center position-relative z-1" style={{ gap: 8, listStyle: "none", padding: 0 }}>
                  <li><Link href="/" style={{ color: "rgba(255,255,255,0.65)", fontSize: 14 }}>Home</Link></li>
                  <li aria-hidden="true" style={{ color: "rgba(255,255,255,0.40)", fontSize: 14 }}>/</li>
                  {style && <>
                     <li><Link href={link} style={{ color: "rgba(255,255,255,0.65)", fontSize: 14 }}>{link_title}</Link></li>
                     <li aria-hidden="true" style={{ color: "rgba(255,255,255,0.40)", fontSize: 14 }}>/</li>
                  </>}
                  <li aria-current="page" style={{ color: "#f0b95e", fontSize: 14, fontWeight: 600 }}>{sub_title}</li>
               </ol></nav>
            </div>
         </div>
      )
   ...
   return (
      <div className="inner-banner-one inner-banner bg-pink text-center z-1 pt-160 lg-pt-130 pb-160 xl-pb-120 md-pb-80 position-relative">
         ...
         <Image src={breadcrumbImg} alt="" aria-hidden="true" className="lazy-img shapes w-100 illustration" />
      </div>
   )
}
