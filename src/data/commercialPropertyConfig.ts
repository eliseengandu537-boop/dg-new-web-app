...
export const COMMERCIAL_PRICE_RANGE_OPTIONS_BY_LISTING_TYPE: Record<string, SelectOption[]> = {
  ...
  lease: [
    ...
    { value: "lease-r30-to-r150", text: "R30 - R150 / m²" },
    { value: "lease-r150-to-r300", text: "R150 - R300 / m²" },
    { value: "lease-r300-to-r500", text: "R300 - R500 / m²" },
  ],
  investment: [
...
export const COMMERCIAL_PRICE_RANGE_MAP: Record<string, { min?: number; max?: number }> = {
  ...
  "lease-r30-to-r150": { min: 30, max: 150 },
  "lease-r150-to-r300": { min: 150, max: 300 },
  "lease-r300-to-r500": { min: 300, max: 500 },
